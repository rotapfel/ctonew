...
from .constants import (
    HBAR, PI,
    RB85_GROUND_HFS_A, RB85_5P12_HFS_A, RB85_5P32_HFS_A, RB85_5P32_HFS_B,
    RB_D1_REDUCED_DIPOLE, RB_D2_REDUCED_DIPOLE,
    RB_D_LINE_DECAY_RATE, RB85_NUCLEAR_SPIN
)
...
class Rb85System:
    ...
    def __init__(self):
        self.nuclear_spin = RB85_NUCLEAR_SPIN
    ...
    def _create_ground_states(self):
        ...
        states = []
        for F in F_values:
            energy = self._hyperfine_energy(RB85_GROUND_HFS_A, 0, I, J, F)
            level = AtomicLevel(
    ...
    def _create_5p12_states(self):
        ...
        states = []
        for F in F_values:
            hf_energy = self._hyperfine_energy(RB85_5P12_HFS_A, 0, I, J, F)
    ...
    def _create_5p32_states(self):
        ...
        states = []
        for F in F_values:
            hf_energy = self._hyperfine_energy(RB85_5P32_HFS_A, RB85_5P32_HFS_B, I, J, F)
            energy = base_energy + hf_energy
            level = AtomicLevel(
                n=5, L=1, J=J, F=float(F), mF=0.0,
                energy=energy,
    ...
    def __repr__(self):
        return (f"Rb85System(ground_states={len(self.ground_states)}, "
